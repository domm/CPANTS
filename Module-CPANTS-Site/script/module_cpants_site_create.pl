...
module_cpants_site_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   module_cpants_site_create.pl model SomeDB DBIC::Schema MyApp::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   module_cpants_site_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
